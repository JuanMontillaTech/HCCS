...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IUserValidator usersValidator)
        {
            this._users = usersValidator;
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_users.ValidateCredentials(model.Username, model.Password))
                {
                    ...
                    {
                         throw new Exception("devolución inválida URL");
                    }
                }

                await _events.RaiseAsync(new UserLoginFailureEvent(model.Username, "credenciales no válidas", clientId: context?.Client.ClientId));
