    ...
    public partial class ConfigurationDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Web Api para el Sistema de Consejería", false, true, "con_api", false, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2592000, 60, 0, false, true, false, false, null, false, false, 300, true, null, "client_", "nuxt", "Cliente de la aplicación NuxtJs", null, null, new DateTime(2021, 6, 24, 12, 13, 43, 488, DateTimeKind.Utc).AddTicks(6467), null, 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, false, false, true, false, 1296000, false, null, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 24, 12, 13, 43, 409, DateTimeKind.Utc).AddTicks(1246), "Información de identidad como id, código, etc.", "Información de identidad", false, true, "openid", false, true, true, null },
                    { 2, new DateTime(2021, 6, 24, 12, 13, 43, 412, DateTimeKind.Utc).AddTicks(3976), "Información personal como nombre, apellido, foto, etc.", "Información de personal", false, true, "profile", false, false, true, null },
                    { 3, new DateTime(2021, 6, 24, 12, 13, 43, 412, DateTimeKind.Utc).AddTicks(4597), "Información de roles y permisos como, administrador, consejero, estudiante, etc.", "Rol de usuario", false, true, "role", false, false, true, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "http://localhost:3000/signed-out" });
